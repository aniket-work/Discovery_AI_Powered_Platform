...
with st.sidebar:
    ...
    selected = option_menu(
        menu_title=None,
        options=["Profile", "Create Space", "Analyze", "Search", "Settings"],
        icons=["person", "plus-square", "graph-up", "search", "gear"],
        default_index=1,
...
st.markdown(
    ...
    <div class="custom-footer">
        © 2024 Discovery AI-Powered Platform For Data Analysis & Discovery . All rights reserved.
    </div>
    """,
    unsafe_allow_html=True
)